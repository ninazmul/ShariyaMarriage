...
const Signin = () => {
  ...
  return (
    <div className="min-h-screen">
      <div className="flex flex-col md:flex-row-reverse gap-10 p-4 items-center">
        {/* left side  */}
        <div className="flex flex-col items-center md:w-1/2 gap-4">
          <Link to="/">
            <h1 className="text-4xl lg:text-6xl font-bold text-center font-serif text-[#4c8e40]">
              Shariya Marriage
            </h1>
          </Link>
          <h1 className="text-3xl lg:text-4xl flex items-center font-bold font-mono text-[#4c8e40]">
            Welcome Back!
          </h1>

          <p className="text-justify">
            Sign In to Continue Your Journey to a Faithful Union
          </p>
        </div>
        {/* right side  */}
